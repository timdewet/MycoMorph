"""Stage protocol + adapters wrapping mycomorph.core.api functions.
...
class ExtractStage:
    ...
    def run(self, ctx, progress_cb: ProgressCB) -> list[Path]:
        ...
        if opts is None:
            from mycomorph.core.api import ExtractOpts as _EO
            opts = _EO()
        ...
        if outputs and getattr(opts, "add_to_library", False) and all_pq.exists():
            try:
                ...
                try:
                    from mycomorph.core.extract.qc_plots import (
...
class EmbeddingsStage:
    ...
    def run(self, ctx, progress_cb: ProgressCB) -> list[Path]:
        ...
        from mycomorph.core.autoencoder import AutoencoderConfig, extract_embeddings, train_autoencoder
        ...
        if is_supcon:
            from mycomorph.core.autoencoder.supcon import train_supcon as _train_fn
