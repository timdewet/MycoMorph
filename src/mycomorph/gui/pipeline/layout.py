...
# ─────────────────────────────────────────────────────────────────────────────
# Well-ID helpers (mirror mycomorph.core.split_czi_plate so naming stays in sync)
# ─────────────────────────────────────────────────────────────────────────────
...
class PlateLayout:
    ...
    def from_czis(
        ...
        """
        try:
            from mycomorph.core.split_czi_plate import extract_scene_well_map
        except ImportError as e:
            raise RuntimeError(
                "mycomorph.core not importable. Reinstall the project: `pip install -e .`."
            ) from e
