...
from mycomorph.core.api import ExtractOpts
...
class FeaturesPanel(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.library_dir.setPlaceholderText("~/.mycomorph/morphology_library/")
    ...
    def _import_existing_parquet(self) -> None:
        ...
        if not path:
            return
        from mycomorph.core.extract.feature_library import (
            FeatureLibrary,
