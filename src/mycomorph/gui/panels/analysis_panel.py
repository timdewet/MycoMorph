...
class _CompareWorker(QObject):
    ...
    def run(self) -> None:
        try:
            from mycomorph.core.extract.qc_plots import render_comparison_html
...
class _EmbeddingsWorker(QObject):
    ...
    def run(self) -> None:
        try:
            from mycomorph.core.extract.qc_plots import render_embeddings_html
...
class _EmbeddingsOTWorker(QObject):
    ...
    def run(self) -> None:
        try:
            from mycomorph.core.extract.qc_plots import render_embeddings_ot_html
...
class _FeaturesOTWorker(QObject):
    ...
    def run(self) -> None:
        try:
            from mycomorph.core.extract.qc_plots import render_features_ot_html
...
class _LibraryWorker(QObject):
    ...
    def run(self) -> None:
        try:
            from mycomorph.core.extract.qc_plots import render_library_html
...
class AnalysisPanel(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self._tmp_dir = Path(tempfile.mkdtemp(prefix="mycomorph_analysis_"))
    ...
    def _ot_sidecar_for_current_view(self) -> Optional[Path]:
        from mycomorph.core.extract.qc_plots import _ot_sidecar_path
    ...
    def _export_ranked_matches(self) -> None:
        ...
        if not out:
            return
        try:
            from mycomorph.core.extract.ot_analysis import rank_condition_matches
    ...
    def _export_permutation_test(self) -> None:
        ...
        if not out:
            return
        try:
            from mycomorph.core.extract.ot_analysis import permutation_test
            df = permutation_test(
                emb_path, sidecar,
    ...
    def _populate_gene_combo(self) -> None:
        ...
        from mycomorph.core.extract.qc_plots import library_gene_list
    ...
    def _populate_feature_combo(self) -> None:
        ...
        """
        from mycomorph.core.extract.qc_plots import library_feature_columns
