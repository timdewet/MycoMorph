...
from mycomorph.core.api import PRESET_MODELS, resolve_classifier_preset
...
class _ActiveLearningWorker(QThread):
    ...
    def run(self) -> None:    # noqa: D401
        try:
            ...
            from mycomorph.core.cell_quality_classifier import (
                CROP_SIZE,
...
class _TrainWorker(QThread):
    ...
    def run(self) -> None:
        try:
            from mycomorph.core.train_classifier import train
            summary = train(
...
class LabelTrainPanel(QWidget):
    ...
    def _save_batch(self, _checked: bool = False, silent_if_empty: bool = False) -> int:
        ...
        from mycomorph.core.cell_quality_classifier import CLASS_NAMES
        ...
        from mycomorph.core.cell_quality_classifier import CROP_SIZE
