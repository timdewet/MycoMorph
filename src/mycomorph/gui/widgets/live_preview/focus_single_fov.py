"""Single-FOV in-memory focus, mirroring ``mycomorph.core.focus.pipeline._process_scene``.
...
(currently nothing), it should live here so the mycomorph.core module
stays untouched.
"""
...
def run(
    ...
    grayscale plane.
    """
    from mycomorph.core.focus import (
        channel_id,
        focus as focus_metrics,
        io_czi,
        tiling,
    )
    from mycomorph.core.focus.pipeline import (
        Options,
