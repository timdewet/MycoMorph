...
Wraps :func:`mycomorph.core.extract.per_cell.extract_fov_features` so we
...
def run(
    ...
    """
    from mycomorph.core.api import DEFAULT_PIXELS_PER_UM
    from mycomorph.core.extract.per_cell import extract_fov_features
