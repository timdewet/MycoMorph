...
def library_list(
    ...
    library_dir: str = typer.Option(
        "", "--dir", help="Library directory (default: ~/.mycomorph/feature_library/)."
    ),
) -> None:
...
def library_gene_template(
    ...
    def _gene_from_row(row, primary_col, fallback_col):
        ...
        For MycoMorph wells the canonical form is
    ...
    typer.echo(
        ...
        f"  mycomorph-cli library compare-representations {out_path}"
...
def library_compare_representations(
    ...
    library_dir: str = typer.Option(
        "", "--dir", help="Library directory (default: ~/.mycomorph/morphology_library/)."
    ),
